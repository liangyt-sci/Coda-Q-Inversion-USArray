function [new_data, kept_events, kept_stations] = filter_event_station_pairs_public(data, min_stations_per_event, min_events_per_station)
%FILTER_EVENT_STATION_PAIRS_PUBLIC Keep a connected event-station subset.
%
